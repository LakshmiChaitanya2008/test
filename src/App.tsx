    ...
    <main className="main px-5">
      ...
      <div className="about  mx-3" ref={aboutRef}>
        ...
        <p className=" mt-2">
          ...
          AICTE. The Polytechnic was the Second Self Financing institution in
          the state of Andhra Pradesh and the first of its kind in Krishna
          district., This is the first Polytechnic in the country to have
          diplomated two blind students in technical students in technical
          courses.Our polytechnic envisions to be an ideal polytechnic in the
          state, moulding the students to be potential professionals with all
          skills of a true diploma engineer in their respective branches,
          stimulating their inherent spirits of innovation, creativity and
          research with values to become competent contributors to the Nation’s
          wealth and advancements in engineering world.
        </p>
